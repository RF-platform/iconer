...
const GameItemCard = ({ itemData, lang }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-full top-0 ml-2 min-w-[450px] z-50 origin-left"
        style={cardStyle}
      >
        <div
        ...
        >
          ...
          <div
            className={`w-16 h-16 shrink-0 right-4 absolute top-4 bg-gray-800 border ${colors.borderColor}`}
          >
            <div
              className="w-full h-full bg-no-repeat"
              style={{
